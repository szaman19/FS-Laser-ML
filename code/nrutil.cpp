...
complex<double> *compvector(long nl, long nh)
...
complex<double> **compmatrix(long nrl, long nrh, long ncl, long nch)
...
void free_compvector(complex<double> *v, long nl, long nh)
...
void free_compmatrix(complex<double> **m, long nrl, long nrh, long ncl, long nch)
/* free a complex matrix allocated by matrix() */
{
	free((FREE_ARG) (m[nrl]+ncl-NR_END));
	free((FREE_ARG) (m+nrl-NR_END));
}
